...
/**
 * @description spawn和spawnSync的跨平台解决方案。
 * @docsUrl https://www.npmjs.com/package/cross-spawn
 */
...
export function resolveNpmSync (pluginName: string, root): string {
  try {
    ...
    console.log("resolveNpmSync-err", err);
    console.log("resolveNpmSync-err-pluginName", pluginName);
