/**
 * @description 提供通用的加密和哈希算法
 * @docsUrl https://www.liaoxuefeng.com/wiki/1022910821149312/1023025778520640
 */
import crypto from 'crypto'
import * as fs from 'fs-extra'
import * as path from 'path'
/**
 * @description xxHash是一个非常快的hash算法
 * @docsUrl https://github.com/pierrec/js-xxhash
 */
